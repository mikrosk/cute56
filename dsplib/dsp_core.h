...
void DSPSHARED_EXPORT dsp_core_init(dsp_core_t *dsp_core);
void DSPSHARED_EXPORT dsp_core_shutdown(dsp_core_t *dsp_core);
void DSPSHARED_EXPORT dsp_core_reset(dsp_core_t *dsp_core);

/* Post a new interrupt to the interrupt table */
void DSPSHARED_EXPORT dsp_core_add_interrupt(dsp_core_t *dsp_core, Uint32 inter);

/* host port read/write by emulator, addr is 0-7, not 0xffa200-0xffa207 */
Uint8 DSPSHARED_EXPORT dsp_core_read_host(dsp_core_t *dsp_core, int addr);
void DSPSHARED_EXPORT dsp_core_write_host(dsp_core_t *dsp_core, int addr, Uint8 value);

/* dsp_cpu call these to read/write host port */
void DSPSHARED_EXPORT dsp_core_hostport_dspread(dsp_core_t *dsp_core);
void DSPSHARED_EXPORT dsp_core_hostport_dspwrite(dsp_core_t *dsp_core);

/* dsp_cpu call these to read/write/configure SSI port */
void DSPSHARED_EXPORT dsp_core_ssi_configure(dsp_core_t *dsp_core, Uint32 adress, Uint32 value);
void DSPSHARED_EXPORT dsp_core_ssi_receive_serial_clock(dsp_core_t *dsp_core);
void DSPSHARED_EXPORT dsp_core_ssi_receive_SC2(dsp_core_t *dsp_core, Uint32 value);
void DSPSHARED_EXPORT dsp_core_ssi_writeTX(dsp_core_t *dsp_core, Uint32 value);
void DSPSHARED_EXPORT dsp_core_ssi_writeTSR(dsp_core_t *dsp_core);
Uint32 DSPSHARED_EXPORT dsp_core_ssi_readRX(dsp_core_t *dsp_core);
void DSPSHARED_EXPORT dsp_core_ssi_generate_internal_clock(dsp_core_t *dsp_core);



/* Process peripheral code */
void DSPSHARED_EXPORT dsp_core_process_host_interface(dsp_core_t *dsp_core);	/* HI */
void DSPSHARED_EXPORT dsp_core_process_ssi_interface(dsp_core_t *dsp_core);	/* SSI */
