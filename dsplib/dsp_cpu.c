...
static int dsp_disasm_inst	= 0;	/* Instructions */
static int dsp_disasm_reg	= 0;	/* Registers changes */
static int dsp_disasm_mem	= 0;	/* Memory changes */
...
void write_memory_raw(int space, Uint16 address, Uint32 value)
{
	value &= BITMASK(24);
