...
;; this one does not freeze up.
		...
		xdef	_asm_dsp_load_program
	
; ------------------------------------------------------
		section	text
; ------------------------------------------------------

_asm_dsp_load_program:
		move.l	(4,sp),dsp_program
		move.l	(8,sp),dsp_length
...
dsp_go:		; Load system startup code.
